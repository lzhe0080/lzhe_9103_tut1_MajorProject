...
function drawSecondBuilding() {
  ...
  let movement2 = 0;
  if(pan<0){
    movement2 = map(pan,0,-1,0,-1/4*windowWidth);
  }else{
    movement2 = map(pan,0,1,0,1/2*windowWidth);
  }
  translate(secondSegStart+movement2, 0);
...
function drawThirdBuilding() {
  ...
  let movement3 = 0;
  if(pan<0){
    movement3 = map(pan,0,-1,0,-1/2*windowWidth);
  }else{
    movement3 = map(pan,0,1,0,1/4*windowWidth);
  }
  translate(thirdSegStart+movement3, 0); 
...
function drawFourthBuilding() {
  ...
  let movement4 = 0;
  if(pan<0){
    movement4 = map(pan,0,-1,0,-3/4*windowWidth);
  }
  translate(fourthSegStart+movement4, 0);
...
function mouseMoved() {
  //Use the position of mouse to control the volume and panning of the song
